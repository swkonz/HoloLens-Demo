...
namespace dx11HoloLensDemo
{
    class dx11HoloLensDemoMain : public DX::IDeviceNotify
    {
    public:
        dx11HoloLensDemoMain(std::shared_ptr<DX::DeviceResources> const& deviceResources);
        ~dx11HoloLensDemoMain();
