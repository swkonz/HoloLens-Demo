#include "pch.h"
#include "dx11HoloLensDemoMain.h"
...
dx11HoloLensDemoMain::dx11HoloLensDemoMain(std::shared_ptr<DX::DeviceResources> const& deviceResources) :
    m_deviceResources(deviceResources)
{
    ...
    m_gamepadAddedEventToken = Gamepad::GamepadAdded(bind(&dx11HoloLensDemoMain::OnGamepadAdded, this, _1, _2));
    m_gamepadRemovedEventToken = Gamepad::GamepadRemoved(bind(&dx11HoloLensDemoMain::OnGamepadRemoved, this, _1, _2));
    ...
    if (m_canGetDefaultHolographicDisplay)
    {
        ...
        m_holographicDisplayIsAvailableChangedEventToken = HolographicSpace::IsAvailableChanged(bind(&dx11HoloLensDemoMain::OnHolographicDisplayIsAvailableChanged, this, _1, _2));
    }
...
void dx11HoloLensDemoMain::SetHolographicSpace(HolographicSpace const& holographicSpace)
{
    ...
    m_cameraAddedToken = m_holographicSpace.CameraAdded(std::bind(&dx11HoloLensDemoMain::OnCameraAdded, this, _1, _2));
    ...
    m_cameraRemovedToken = m_holographicSpace.CameraRemoved(std::bind(&dx11HoloLensDemoMain::OnCameraRemoved, this, _1, _2));
...
void dx11HoloLensDemoMain::UnregisterHolographicEventHandlers()
{
...
dx11HoloLensDemoMain::~dx11HoloLensDemoMain()
{
...
HolographicFrame dx11HoloLensDemoMain::Update()
{
...
bool dx11HoloLensDemoMain::Render(HolographicFrame const& holographicFrame)
{
...
void dx11HoloLensDemoMain::SaveAppState()
{
    //
...
void dx11HoloLensDemoMain::LoadAppState()
{
    //
...
void dx11HoloLensDemoMain::OnPointerPressed()
{
    m_pointerPressed = true;
}
...
void dx11HoloLensDemoMain::OnDeviceLost()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void dx11HoloLensDemoMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void dx11HoloLensDemoMain::OnLocatabilityChanged(SpatialLocator const& sender, winrt::Windows::Foundation::IInspectable const& args)
{
...
void dx11HoloLensDemoMain::OnCameraAdded(
...
void dx11HoloLensDemoMain::OnCameraRemoved(
    HolographicSpace const& sender,
...
void dx11HoloLensDemoMain::OnGamepadAdded(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void dx11HoloLensDemoMain::OnGamepadRemoved(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void dx11HoloLensDemoMain::OnHolographicDisplayIsAvailableChanged(winrt::Windows::Foundation::IInspectable, winrt::Windows::Foundation::IInspectable)
{
    ...
    if (m_spatialLocator != spatialLocator)
    {
        ...
        if (spatialLocator != nullptr)
        {
            ...
            m_locatabilityChangedToken = m_spatialLocator.LocatabilityChanged(std::bind(&dx11HoloLensDemoMain::OnLocatabilityChanged, this, _1, _2));
